...
- **A message a view says is not an overlay it owns.** Sonner keeps one list of messages for the document and every mounted Toaster draws all of it, so hiding the section that raised one does not take it away — it is redrawn by the Toaster of the section switched to, and a message raised after leaving is said over a section that never asked. Views do not reach for Sonner directly: `on-screen-toast` says nothing while the view is off screen and drops what it has said as the view goes.
