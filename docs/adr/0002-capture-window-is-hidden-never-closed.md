...
- **The focus handback described below has since changed.** Dismissing a Capture no longer hides the application; it reactivates whatever was frontmost when the Capture began — see [0023](0023-the-app-enters-the-dock-only-while-the-main-window-is-open.md).
