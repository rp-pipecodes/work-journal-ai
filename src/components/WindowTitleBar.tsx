 ...
 *
 * The Main Window, Tasks View and Settings are built with an overlay title bar
 * — see `show_on_demand_window` in `src-tauri/src/lib.rs` — so the webview is
 * handed the whole window, title bar included, and the close, minimise and zoom
